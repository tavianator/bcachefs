...
#define BCH_SB_ERRS()									\
	...
	x(extent_block_checksums_csum_type_unknown,		277,	0)		\
	x(extent_block_checksums_front_pad_bad,			278,	0)		\
	x(extent_block_checksums_back_pad_bad,			279,	0)		\
	x(extent_block_checksums_misaligned,			280,	0)		\
	x(extent_block_checksums_val_size_bad,			281,	0)
